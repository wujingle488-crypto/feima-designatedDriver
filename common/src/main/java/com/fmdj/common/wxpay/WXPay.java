...
public class WXPay {
    ...
    public boolean isResponseSignatureValid(Map<String, String> reqData, WXPayConstants.SignType signType) throws Exception {
        // 返回数据的签名方式和请求中给定的签名方式是一致的
    ...
    public Map<String, String> processResponseXml(String xmlStr, WXPayConstants.SignType signType) throws Exception {
        String RETURN_CODE = "return_code";
        String return_code;
        Map<String, String> respData = WXPayUtil.xmlToMap(xmlStr);
        if (respData.containsKey(RETURN_CODE)) {
